...
class SettingConfig{
  ...
  const SettingConfig({isAutoScroll, homeItemCount,rankType , receiveNotify}): this.isAutoScroll = isAutoScroll ?? true , this.receiveNotify = receiveNotify ?? true, this.homeItemCount = homeItemCount?? kBaseHomeItemCount ,this.rankType = rankType ?? kBaseRankItem;
