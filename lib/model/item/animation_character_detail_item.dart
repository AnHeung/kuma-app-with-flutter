...
class AnimationCharacterDetailItem {
  ...
  const AnimationCharacterDetailItem({
      this.characterId,
      this.name,
      this.nameKanji,
      this.nicknames,
  ...
  static const empty = AnimationCharacterDetailItem(characterId: "" , url: "", voiceActors: [],relateAnimation: [], nicknames: "",nameKanji: "",name: "",imageUrl: "", about: "",pictureItems:[],favoritesRank: "");
}
